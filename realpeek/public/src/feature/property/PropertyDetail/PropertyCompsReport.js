...
class PropertyCompsReport extends Component {
    constructor(props) {
        super(props);
    }
                ...
                <Col xs={6} md={2}>
                    <CardBody>
                        <Row>
                            ...
                            <OptionRow name='Max Days' value={this.props.assumptions[maxDays]} />
                        </Row>
                    </CardBody>
                </Col>
                <Col xs={6} md={10}>
    ...
    render() {
        ...
        const subjectProperty = property.subject_property;
  ...
  export default PropertyCompsReport;