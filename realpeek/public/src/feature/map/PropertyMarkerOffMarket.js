...
class PropertyMarkerOffMarket extends PureComponent {
    constructor(props) {
        super(props);
        this.state = {
    ...
    render() {
        ...
        let cma = property.cma ? property.cma.cma.cma_results : null;
        if (cma) {
        ...
        // }
        // else if (property.success === false) {
        ...
        return <div>
            <Marker icon={markerIcon} position={{ lat: property.lat, lng: property.long }} onClick={this.handleToggleOpen}
...
export default PropertyMarkerOffMarket